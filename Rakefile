...
Motion::Project::App.setup do |app|
  ...
  app.vendor_project "vendor/hello", :static
...
task :build_c do
  script = <<SCRIPT
  set -x
  clang ./ffi/hello.c -c -I ./ffi/hello.h -o ./ffi/hello.o
  cp ./ffi/hello.h ./vendor/hello/
  cp ./ffi/hello.o ./vendor/hello/
SCRIPT
